...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OCTR" Or strTab = "CTR1" Or strTab = "OITT" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "OCTR") Then
                strTab = "@" + strTab
            End If
            ...
            If Not IsColumnExists(strTab, strCol) Then
                ...
                'If strCol = "Z_Currency" Then
                '    oUserFieldMD.LinkedTable = "OCRN"
                'End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        ...
        Try
            ...
            AddFields("OCTR", "Z_ContAmt", "Contract Amount", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            addField("OCTR", "Z_WarType", "Warranty Type", SAPbobsCOM.BoFieldTypes.db_Alpha, 10, SAPbobsCOM.BoFldSubTypes.st_Address, "F,W,R", "Free,Warranty,Regular", "F")
            addField("OCTR", "Z_Invoice", "Invoice Issued", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            ' addField("OCTR", "Z_GLAcc", "G/L Account Generation", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddFields("OCTR", "Z_GLAcc", "Invoice G/L Account", SAPbobsCOM.BoFieldTypes.db_Alpha, , 210)
            AddFields("OCTR", "Z_InvNo", "Invoice Number", SAPbobsCOM.BoFieldTypes.db_Alpha, , 20)
            addField("OCTR", "Z_Renewal", "Renewal", SAPbobsCOM.BoFieldTypes.db_Alpha, 1, SAPbobsCOM.BoFldSubTypes.st_Address, "Y,N", "Yes,No", "N")
            AddFields("OCTR", "Z_BaseCoNo", "Base Contract No", SAPbobsCOM.BoFieldTypes.db_Numeric)
            AddFields("OCTR", "Z_Currency", "Currency", SAPbobsCOM.BoFieldTypes.db_Alpha, 5)
            ' AddFields("RDR1", "RemQty", "Invoiced Quantity", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Quantity)

            AddFields("CTR1", "Bprice", "Base Price", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("CTR1", "247price", "24h/7d Price", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
            AddFields("CTR1", "Fprice", "Full Price", SAPbobsCOM.BoFieldTypes.db_Float, , , SAPbobsCOM.BoFldSubTypes.st_Sum)
