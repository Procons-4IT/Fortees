            ...
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    ...
                    Case mnu_ContRenewal
                        oMenuObject = New clsContRenewal
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
                    Case mnu_InvGeneration
                        oMenuObject = New clsInvGeneration
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
...
#Region "Item Event"
    Private Sub SBO_Application_ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean) Handles _SBO_Application.ItemEvent
        Try
            ...
            If pVal.FormTypeEx = "-60126" Then
                If pVal.ItemUID = "U_Z_InvNo" And (pVal.EventType = SAPbouiCOM.BoEventTypes.et_RIGHT_CLICK Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_CLICK Or pVal.EventType = SAPbouiCOM.BoEventTypes.et_KEY_DOWN) Then
            ...
            If pVal.EventType <> SAPbouiCOM.BoEventTypes.et_FORM_UNLOAD Then
                Select Case pVal.FormTypeEx
                    Case frm_ContRenewal
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsContRenewal
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_InvGeneration
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsInvGeneration
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
...
#End Region
    ...
    Private Sub _SBO_Application_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles _SBO_Application.RightClickEvent
        ...
        If oform.TypeEx = "-60126" Then
            If eventInfo.ItemUID = "U_Z_InvNo" And (eventInfo.EventType = SAPbouiCOM.BoEventTypes.et_RIGHT_CLICK) Then
                BubbleEvent = False
                Exit Sub
            End If
        End If
