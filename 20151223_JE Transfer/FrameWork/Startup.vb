...
#Region "Declaration"
    ...
    Public strCust, strSOHead, strSOLines, strFilePath, strExportFilePaty, strFileStart, strErrorLogPath, strErrorFileName As String
    ...
    Public dtStartDate, dtEndDate, dtPostingDate As Date
#End Region
